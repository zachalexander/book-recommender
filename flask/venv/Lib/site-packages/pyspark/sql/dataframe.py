...
class DataFrame(object):
    ...
    def explain(self, extended=False):
        ...
        *(1) Scan ExistingRDD[age#0,name#1]
        ...
        ...
        """
        if self._sc._jvm.com.databricks.spark.util.SparkClientContext.clientEnabled():
            print(self._sc._jvm.PythonSQLUtils.explainString(self._jdf.queryExecution(), extended))
        else:
            if extended:
